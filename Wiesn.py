...
# ------------------------------------------------------------------------------
# Eingabe (mit Entsperren per Mitarbeiter-Passwort) – bleibt nach Speichern auf Datum
# ------------------------------------------------------------------------------
...
def eingabe(datum):
    ...
    # --- Speichern (bleibt nachher auf /eingabe/<datum>) ---
              ...
              <div class="row g-3">
                <div class="col-12 col-md-6">
                  ...
                  <input type="number" step="0.01" name="summe_start" value="{{summe_start}}"
                         class="form-control {% if im_edit_zeitraum and not gespeichert and datum==('%s') %}editable{% else %}readonly{% endif %}"
                         {% if not (im_edit_zeitraum and not gespeichert and datum==('%s')) %}readonly{% endif %}>
                </div>
    ...
    """.replace("('%s')", DATA_START.isoformat()),  # kleine Hilfe für 'ist erster Tag' im Template
        datum=datum,
        name=aktiver_user,
